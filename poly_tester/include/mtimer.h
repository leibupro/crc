 ...
 * date type:  ttimer_t
 * functions:  startTTimer(ttimer_t tdata) -> start timer
 *             stopTTimer(ttimer_t tdata)  -> stop  timer
...
#define printGTime(X)   printf("elapsed %3.4fs\n", getWallGTime(X))
...
#define printTTime(X)   \
    printf("elapsed %10.4fs, sys %10.4fs, user %10.4fs\n", \
...
#define printCTime(X)       switch (X.clockID) { \
                                case REALTIME :  \
                                    printf("elapsed %12.6f s\n", getCTime(X)); \
                                    break;       \
                                case MONOTONIC:  \
                                    printf("elapsed %12.6f s\n", getCTime(X)); \
                                    break;       \
                                case PROCESS:    \
                                    printf("process %12.6f s\n", getCTime(X)); \
                                    break;       \
                                case THREAD:     \
                                    printf("thread %12.6f s\n", getCTime(X));  \
                                    break;       \
                                default:         \
                                    break;       \
                            }
